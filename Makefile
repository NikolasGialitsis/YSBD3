...
sr_main1:
	...
	gcc -lm -g3 -I ./include/ -L ./lib/ -Wl,-rpath,./lib/ ./examples/sr_main1.c ./src/sort_file.c -lbf -o ./build/sr_main1 -O2

sr_main2:
	@echo " Compile sr_main2 ...";
	gcc -lm -g3 -I ./include/ -L ./lib/ -Wl,-rpath,./lib/ ./examples/sr_main2.c ./src/sort_file.c -lbf -o ./build/sr_main2 -O2
